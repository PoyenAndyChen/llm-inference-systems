...
These figures are arithmetic on vendor-published peaks and should be read as order-of-magnitude. Real production J/token at the data-center boundary includes fabric, host CPU, cooling, and PUE, which typically add a 1.5–2× multiplier. The serving-economics numbers in [§50/02-economics-and-tco](../50-cluster-systems/02-economics-and-tco.md) (when published) work the math at the cluster level.
