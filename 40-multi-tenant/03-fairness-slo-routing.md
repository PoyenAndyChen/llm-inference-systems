...
Production deployments compose the systems above into a five-layer stack. The pattern at AIBrix, llm-d, and the vLLM production stack [see §80/05-dynamo-llmd-aibrix](../80-oss-deep-dives/05-dynamo-llmd-aibrix.md) is:
