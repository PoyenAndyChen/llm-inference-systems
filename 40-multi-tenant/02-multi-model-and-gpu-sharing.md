...
NVIDIA's acquisition of Run.AI was announced in late 2024 and closed by year-end per public press; the open-source release of KAI Scheduler followed in 2025, though precise feature parity between the OSS release and the Run.AI Atlas commercial offering is in flux as of mid-2026. The OSS release covers core scheduling logic; surrounding control-plane features (workspace UX, dashboards, quota policy) are not all OSS. Adoption is concentrated in NVIDIA-aligned customers — cloud providers running NVIDIA AI Enterprise, sovereign-AI deployments, dedicated enterprise GPU clusters — and broader OSS adoption beyond that base is still developing.
